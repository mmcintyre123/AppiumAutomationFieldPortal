...
module.exports = function () {
	...
	describe("Remove Salutations and Suffices and perform any other data cleansing tasks before running automation", function() {
		...
		it('Should remove salutations and suffices from prospects', function () {
			return driver
				.sleep(1)
				.then(function () {
        ...
        it('Should remove salutations and suffices from volunteers', function () {
			return driver
				.sleep(1)
				.then(function () {
